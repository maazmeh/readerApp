...
import {registerUser, uploadAndRegister} from '../Providers/http';
...
const SignupScreen: React.FC = ({navigation, route}) => {
  ...
  const registerButton = () => {
    ...
    registerUser(name, password, email, phoneNumber, address, imageURL, gender)
      .then((resp: any) => {
        setisLoading(false)
  ...
  const openLogin = (userId:any) => {
    navigation.navigate('SelectChannel',{userId})
  }
